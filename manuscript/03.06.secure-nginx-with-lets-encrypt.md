...
> TODO: This is currently allowing HTTP & HTTPS traffice in. Once working, try removing HTTP and allowing HTTPS only.
...
Go back to the browser where you had api.klequis-todo.tk and refresh. You should see the URL change to https://aip.klequis-todo.tk and the browsers security indicator should be positive.
