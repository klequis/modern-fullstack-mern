...
Finally, my keyboard has only one Windows key and it is on the right side. Ubuntu expects there to be one on the right side so the onle on the right does nothing. To fix this:
